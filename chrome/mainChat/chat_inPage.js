...
lookForApiKeys(0);
      ...
      if (chatData.hasOwnProperty(key) && chatData[key]['text'] !== null ) {
        if (typeof chatData[key]['user'] !== 'undefined' || chatData[key]['uuid'] == "system") {
          ...
          if(chatData[key]['uuid'] == config['uuid'])  {
            ...
            var likeGlowClass = "";
            if(numLikes <= 0) {
              numLikes = '<span class="likeNumberCont">&nbsp;Like</span>';
            } else {
              if(numLikes > 9) var likeGlowClass = "gotlike_9";
              else var likeGlowClass = "gotlike_"+numLikes;
              numLikes = '<span class="likeNumberCont' + likeColorClass + '">+<span class="likeNumber">&nbsp;' + numLikes + '</span> </span>';
            }
            extraActionIcon += '<span class="'+likeColorClass+' likeMessage" onClick='+"'"+'likeMessage("'+chatBoxId+'","'+groupID+'","'+chatData[key]['id']+'");'+"'"+'><img height="12.8px" src="' + (chatData[key].likes && chatData[key].likes[config['uuid']] ? likeDataURIs[1] : likeDataURIs[0]) + '">' + numLikes + '</span>';
            extraActionIcon += '<span class="showInfo" onclick="lookUpMember(\'' + chatData[key]['uuid'] + '\', \'mid_' + chatData[key]['id'] + '\', \'' + (contributorTier && contributorTier >= 4 ? chatData[key]['client'] : '') + '\')" style="font-size: 12.8px"><img height="12.8px" src="data:image/png;base64,"></span>';
            // The message
            var chatText = habiticaMarkdown.render(chatData[key]['text']);
          }
          ...
          var userLabel = '<span onClick="mention(\''+chatBoxId+'\',\''+chatData[key]['username']+'\')"><span class="label label-default '+contributorLabel+'">&nbsp;'+chatData[key]['user']+'&nbsp;' + userSymbol +'</span>&nbsp;&nbsp;<span class="label label-username">@' + chatData[key]['username'] + '</span></span>';
  ...
  function createAvatarHead (avatarData, uuid) {
    ...
    if (avatarData['stats']['buffs']) {
      if (avatarData['stats']['buffs']['seafoam']) {
        ...
        '<a href="/profile/' + uuid + '" target="_blank"><div class="herobox">' +
          '<div class="character-sprites">' +
            '<span class="seafoam_star" data-v-59c0708a>' +
          '</div>' +
        '</div></a>';
        ...
        '<a href="/profile/' + uuid + '" target="_blank"><div class="herobox">' +
          '<div class="character-sprites">' +
            '<span class="avatar_floral_' + avatarData['stats']['class'] + '" data-v-59c0708a>' +
          '</div>' +
        '</div></a>';
        ...
        '<a href="/profile/' + uuid + '" target="_blank"><div class="herobox">' +
          '<div class="character-sprites">' +
            '<span class="snowman" data-v-59c0708a>' +
          '</div>' +
        '</div></a>';
        ...
        '<a href="/profile/' + uuid + '" target="_blank"><div class="herobox">' +
          '<div class="character-sprites">' +
            '<span class="ghost" data-v-59c0708a>' +
          '</div>' +
        '</div></a>';
      }
    }
    ...
    return '' +
      '<a href="/profile/' + uuid + '" target="_blank"><div class="herobox">' +
        '<div class="character-sprites">' +
          '<span class="chair_' + avatarData["preferences"].chair + '" data-v-59c0708a></span>' +
          '<span class="' + gear.back + '" data-v-59c0708a></span>' +
          '<span class="' + sleepClass + '" data-v-59c0708a></span>' +
          '<span class="' + avatarData["preferences"].size + '_shirt_' + avatarData["preferences"].shirt + '" data-v-59c0708a></span>' +
          '<span class="' + avatarData["preferences"].size + '_' + gear.armor + '" data-v-59c0708a></span>' +
          '<span class="' + gear.back + '_collar' + '" data-v-59c0708a></span>' +
          '<span class="' + gear.body + '" data-v-59c0708a></span>' +
          '<span class="head_' + avatarData["preferences"].head +'" data-v-59c0708a></span>' +
          '<span class="hair_base_' + avatarData["preferences"].hair.base + hairColor + '" data-v-59c0708a></span>' +
          '<span class="hair_bangs_' + avatarData["preferences"].hair.bangs + hairColor + '" data-v-59c0708a></span>' +
          '<span class="hair_mustache_' + avatarData["preferences"].hair.mustache + hairColor + '" data-v-59c0708a></span>' +
          '<span class="hair_beard_' + avatarData["preferences"].hair.beard + hairColor + '" data-v-59c0708a></span>' +
          '<span class="' + gear.eyewear + '" data-v-59c0708a></span>' +
          '<span class="' + gear.head + '" data-v-59c0708a></span>' +
          '<span class="' + gear.headAccessory + '" data-v-59c0708a></span>' +
          '<span class="hair_flower_' + avatarData['preferences']['hair']['flower'] + '" data-v-59c0708a></span>' +
          '<span class="' + gear.shield + '" data-v-59c0708a></span>' +
          '<span class="' + gear.weapon + '" data-v-59c0708a></span>' +
        '</div>' +
      '</div></a>';
  }
