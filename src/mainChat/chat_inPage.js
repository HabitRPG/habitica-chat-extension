      ...
      if (chatData.hasOwnProperty(key) && chatData[key]['text'] !== null ) {
        if (typeof chatData[key]['user'] !== 'undefined' || chatData[key]['uuid'] == "system") {
          ...
          if(chatData[key]['uuid'] == config['uuid'])  {
            ...
            var extraActionIcon = '<span class="copyMessage" onclick="copyMessageText(\'mid_' + DOMPurify.sanitize(chatData[key]['id'] ) + '\')"><img height="12.8px" src="' + copyDataURI + '"></span>';
            extraActionIcon += '<span class="translateMessage" onclick="translateMessageText(\'mid_' + chatData[key]['id'] + '\')"><img title="Translate" height="12.8px" src="data:image/png;base64,"></span>';
